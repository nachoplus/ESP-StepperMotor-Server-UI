            ...
            <tr v-for="endpoint in endpointDetails" :key="endpoint.id">
              <td>
                <span v-if="endpoint.method == 'GET'">
                  ...
                  <br />
                  <span class="desc">(click to trigger parameterless call)</span>
                </span>
                <b-badge
                  v-if="endpoint.method == 'POST' || endpoint.method == 'PUT'"
                  variant="warning"
                >{{endpoint.method}}</b-badge>
              ...
              <td>
                ...
                >
                  ...
                  <sup>
                    ...
                    <span v-if="!parameter.optional">required</span>
                  </sup>
                  <br />
                  <span class="desc">{{parameter.desc}}</span>
                  <span v-if="parameter.allowedValues.length > 0" class="desc">
                    <strong>Allowed values:</strong>
                    <span v-for="value in parameter.allowedValues" :key="value">'{{value}}'</span>
                    <br />
                  </span>
                </span>
              </td>
    ...
    return {
      ...
      endpointDetails: [
          ...
          parameters: [
            {
              ...
              type: "int",
              optional: false,
              desc: "the id of the stepper motor configuration",
              allowedValues: []
            },
            {
              name: "unit",
              type: "String",
              optional: false,
              desc: "the unit describing the value parameter",
              allowedValues: ["mm", "revs", "steps"]
            },
            {
              name: "value",
              type: "int",
              optional: false,
              desc: "the amount of units to move",
              allowedValues: []
            }
          ],
          output: ""
          ...
          parameters: [
            {
              ...
              type: "int",
              optional: true,
              desc: "the id of the stepper motor configuration to retrieve",
              allowedValues: []
            }
          ],
          output: ""
          ...
          parameters: [
            {
              ...
              type: "int",
              optional: false,
              desc: "the id of the stepper motor configuration to delete",
              allowedValues: []
            }
          ],
        ...
        },
        {
          ...
          paths: ["/api/steppers"],
          description:
            "add a new stepper configuration entry. Returns the id of the newly created stepper configuration",
          parameters: [
            {
              name: "name",
              type: "String",
              optional: false,
              desc:
                "the display name for this stepper configuration. E.g. the axis name for the stepper. Should not be longer then 20 characters",
              allowedValues: []
            },
            {
              name: "stepPin",
              ...
              optional: false,
              desc:
                "the IO pin number of the ESP to use for sending step signals to the stepper driver",
              allowedValues: []
            },
            {
              name: "dirPin",
          ...
          parameters: [
            {
              ...
              type: "int",
              optional: false,
              desc: "the id of the stepper motor configuration to update",
              allowedValues: []
            },
            {
              name: "name",
          ...
          parameters: [
            {
              ...
              type: "int",
              optional: true,
              desc: "the id of the switch status to retrieve",
              allowedValues: []
            }
          ],
          output: ""
          ...
          parameters: [
            {
              ...
              type: "int",
              optional: true,
              desc: "the id of the switch configuration to retrieve",
              allowedValues: []
            }
          ],
          output: ""
        },
        {
          ...
          paths: ["/api/switches"],
          description:
            "endpoint to add a new switch configuration, Retuns the id of the newly created switch configuration in the response",
          parameters: [
            {
              name: "stepperId",
              type: "int",
              optional: false,
              desc:
                "the id of the stepper configuration this switch should be linked to",
              allowedValues: []
            },
            {
              name: "ioPinNumber",
              type: "int",
              optional: false,
              desc: "the IO pin number the switch is connected to",
              allowedValues: []
            },
            {
              name: "positionName",
              ...
              optional: false,
              desc:
                "the name for this switch or the position it represents e.g. 'Homing Switch X-Axis'. Should be no more than 20 characters long",
              allowedValues: []
            },
            {
              name: "switchPosition",
          ...
          parameters: [
            {
              ...
              type: "int",
              optional: false,
              desc: "the id of the switch configuration to update",
              allowedValues: []
            },
            {
              name: "stepperId",
            ...
            },
            {
              ...
              optional: false,
              desc:
                "the type of switch. 4=homing switch begin/left/bottom,8=homing switch end/right/top,16=general position switch,32=emergency stop switch",
        ...
        },
        {
          ...
          parameters: [
            {
              ...
              type: "int",
              optional: false,
              desc: "the id of the switchconfiguration to delete",
              allowedValues: []
            }
          ],
          output: ""
        },
         {
          ...
          method: "GET",
          paths: ["/api/config"],
          description: "get the current IN MEMORY configuration of the server. This config can differ from the saved configuration if modified after calling /api/config/save",
          parameters: [],
          output: ""
        },
        {
          id: 15,
          method: "GET",
          paths: ["/api/config/save"],
          description: "saves the current IN MEMORY configuration of the server to the SPIFFS and therfore makes it survive a reboot and powerloss ",
          parameters: [],
          output: ""
        },
      ]
